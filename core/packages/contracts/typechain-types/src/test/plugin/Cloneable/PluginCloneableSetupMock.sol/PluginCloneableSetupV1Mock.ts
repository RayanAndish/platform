...
export interface PluginCloneableSetupV1MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "prepareInstallation"
...
export interface PluginCloneableSetupV1Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PluginCloneableSetupV1Mock;
