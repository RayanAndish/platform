...
export interface PluginCloneableV2MockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export namespace TargetSet_tuple_Event {
...
export namespace TargetSet_address_uint8_Event {
  export type InputTuple = [target: AddressLike, operation: BigNumberish];
  export type OutputTuple = [target: string, operation: bigint];
  export interface OutputObject {
    target: string;
    operation: bigint;
  }
...
export interface PluginCloneableV2Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PluginCloneableV2Mock;
  ...
  getEvent(
    ...
    TargetSet_tuple_Event.InputTuple,
    TargetSet_tuple_Event.OutputTuple,
    TargetSet_tuple_Event.OutputObject
  >;
  getEvent(
    key: "TargetSet(address,uint8)"
  ): TypedContractEvent<
    TargetSet_address_uint8_Event.InputTuple,
    TargetSet_address_uint8_Event.OutputTuple,
    TargetSet_address_uint8_Event.OutputObject
  >;
  ...
  filters: {
    ...
    "TargetSet(tuple)": TypedContractEvent<
      ...
      TargetSet_tuple_Event.OutputObject
    >;
    "TargetSet(address,uint8)": TypedContractEvent<
      TargetSet_address_uint8_Event.InputTuple,
      TargetSet_address_uint8_Event.OutputTuple,
      TargetSet_address_uint8_Event.OutputObject
    >;
