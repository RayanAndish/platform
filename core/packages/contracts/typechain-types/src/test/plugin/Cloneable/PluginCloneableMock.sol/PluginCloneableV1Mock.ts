...
export interface PluginCloneableV1MockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PluginCloneableV1Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PluginCloneableV1Mock;
