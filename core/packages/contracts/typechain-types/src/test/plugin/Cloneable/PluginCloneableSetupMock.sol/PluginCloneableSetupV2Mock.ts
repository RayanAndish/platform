...
export interface PluginCloneableSetupV2MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "prepareInstallation"
...
export interface PluginCloneableSetupV2Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PluginCloneableSetupV2Mock;
