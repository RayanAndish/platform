...
export interface PluginCloneableSetupV1MockBadInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "prepareInstallation"
...
export interface PluginCloneableSetupV1MockBad extends BaseContract {
  connect(runner?: ContractRunner | null): PluginCloneableSetupV1MockBad;
  ...
  prepareInstallation: TypedContractMethod<
    [_dao: AddressLike, arg1: BytesLike],
    [
