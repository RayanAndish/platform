...
export interface PluginUUPSUpgradeableV2MockInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "initializeV1toV2",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PluginUUPSUpgradeableV2Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PluginUUPSUpgradeableV2Mock;
  ...
  initializeV1toV2: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "initializeV1toV2"
