...
export interface PluginUUPSUpgradeableSetupV1MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "mockHelperCount"
...
export interface PluginUUPSUpgradeableSetupV1Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PluginUUPSUpgradeableSetupV1Mock;
