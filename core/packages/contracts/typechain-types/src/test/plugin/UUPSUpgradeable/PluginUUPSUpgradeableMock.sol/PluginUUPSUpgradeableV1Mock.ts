...
export interface PluginUUPSUpgradeableV1MockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PluginUUPSUpgradeableV1Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PluginUUPSUpgradeableV1Mock;
