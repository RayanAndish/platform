...
export interface PluginUUPSUpgradeableSetupV2MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "mockHelperCount"
...
export interface PluginUUPSUpgradeableSetupV2Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PluginUUPSUpgradeableSetupV2Mock;
