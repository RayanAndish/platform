...
export interface PluginUUPSUpgradeableSetupV1MockBadInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
...
export interface PluginUUPSUpgradeableSetupV1MockBad extends BaseContract {
  connect(runner?: ContractRunner | null): PluginUUPSUpgradeableSetupV1MockBad;
