...
export interface PluginUUPSUpgradeableSetupV4MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "mockHelperCount"
...
export interface PluginUUPSUpgradeableSetupV4Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PluginUUPSUpgradeableSetupV4Mock;
