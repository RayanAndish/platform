...
export interface IPluginSetupInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "prepareInstallation"
...
export interface IPluginSetup extends BaseContract {
  connect(runner?: ContractRunner | null): IPluginSetup;
  waitForDeployment(): Promise<this>;

  interface: IPluginSetupInterface;
