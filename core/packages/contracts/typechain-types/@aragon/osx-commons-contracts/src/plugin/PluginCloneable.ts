...
export interface PluginCloneableInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  getEvent(nameOrSignatureOrTopic: "Initialized" | "TargetSet"): EventFragment;
...
export interface PluginCloneable extends BaseContract {
  connect(runner?: ContractRunner | null): PluginCloneable;
  waitForDeployment(): Promise<this>;

  interface: PluginCloneableInterface;
