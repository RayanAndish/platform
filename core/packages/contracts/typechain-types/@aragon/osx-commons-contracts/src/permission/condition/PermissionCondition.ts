...
export interface PermissionConditionInterface extends Interface {
  getFunction(
    nameOrSignature: "isGranted" | "protocolVersion" | "supportsInterface"
  ): FunctionFragment;
...
export interface PermissionCondition extends BaseContract {
  connect(runner?: ContractRunner | null): PermissionCondition;
